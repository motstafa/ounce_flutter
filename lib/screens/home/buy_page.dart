...
class OperationItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String operationNumber =
        '${S
        .of(context)
        .operationNumberLabel}: ${Operation.generateBigFakeNumber(
        operation.id)}';
    return Container(
      ...
      child: InkWell(
        ...
        borderRadius: BorderRadius.circular(10.0),
        // Ensures ripple effect respects container shape
        child: Column(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              '${S
                                  .of(context)
                                  .totalPriceLabel}: \$${operation.total}',
                              style: TextStyle(
                                  color: buttonAccentColor,
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500),
...
class _PurchaseDialogState extends State<PurchaseDialog> {
      ...
      content: SingleChildScrollView(
        child: ListBody(
          children: _isConfirming
              ? <Widget>[
            _deliveryAvailable ? Text('') : Text(S
                .of(context)
                .busy),
            _deliveryAvailable ? Text(S
                .of(context)
                .noDelay) : Text(S
                .of(context)
                .delayed)
            ...
            Row(
              ...
              children: [
                Text(
                  '${S
                      .of(context)
                      .retailLabel}: ${widget.operation!.retail == 1 ? S
                      .of(context)
                      .trueLabel : S
                      .of(context)
                      .falseLabel}',
  ...
  void showNotEnoughResourcesDialog(BuildContext context) {
    showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
